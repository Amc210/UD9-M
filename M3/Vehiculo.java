...
public class Vehiculo {
	...
	public Vehiculo (String matricula, String marca, String color,Rueda ruedasDelanteras2,Rueda ruedasTraseras2, Persona titular) {
	...
	public Vehiculo (String matricula, String marca, String color,Rueda ruedasDelanteras2,Rueda ruedasTraseras2) {
		comprovarMatricula(matricula);
		this.matricula = matricula;
		this.marca = marca;
		this.color = color;
