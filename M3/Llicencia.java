...
public class Llicencia {
	...
	public Llicencia(int id, String tipoLlicencia, String nomComplet, String caducitat) throws tipoLicenciaIncorecta {
	...
	public boolean comprobarTipo(String tipoLicencia) throws tipoLicenciaIncorecta {
		...
		if (tipoCorrecto==false) {
			throw new tipoLicenciaIncorecta(tipoLicencia);
		}
		return tipoCorrecto;
	}
