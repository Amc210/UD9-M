...
public class M3App {
	...
	public static void main(String[] args) throws tipoLicenciaIncorecta {
		int numeroMaxVehicle = 0, numeroVehicle = 0, numeroMaxPersonas = 0, numeroPersonas = 0;
		Vehiculo[] nuevoVehicle = new Vehiculo[50];
	...
	public static void menu2(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas, int numeroVehicle,
			int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
	...
	public static void menuVehiculo(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas,
			int numeroVehicle, int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
		String vehiculo;
		...
		case "coche":
			if (nuevaPersona[numeroPersonas].licenciaPersona.getTipusLlicencia().equalsIgnoreCase(vehiculo)) {
				...
				throw new tipoLicenciaIncorecta(vehiculo);
			}
	...
	public static void menuVehiculo2(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas,
			int numeroVehicle, int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
		String vehiculo;
		System.out.println("Buenos dias");
		System.out.println("Que tipo de vehiculo tienes? ");
	...
	public static void menuPersona(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas,
			int numeroVehicle, int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
		String persona;
		System.out.println("Buenos dias");
	...
	public static void crearTitular(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas,
			int numeroVehicle, int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
	...
	public static void crearCond(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas, int numeroVehicle,
			int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
		System.out.println("Cual es su nombre? ");
		String nombre = teclat.nextLine();
		System.out.println("Apellido? ");
	...
	public static void coche(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas, int numeroVehicle,
			int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
		...
		while (respuesta.equalsIgnoreCase("si")) {
			...
			if (nuevaPersona[numeroConductor].licenciaPersona.getTipusLlicencia().equalsIgnoreCase("coche")) {
				...
				throw new tipoLicenciaIncorecta("coche");
			}
			System.out.println("Quieres añadir un conductor nuevo?");
	...
	public static void moto(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas, int numeroVehicle,
			int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
		System.out.println("Que matricula tiene? ");
		String matricula = teclat.nextLine();
		System.out.println("Que marca tiene? ");
		...
		while (respuesta.equalsIgnoreCase("si")) {
			...
			if (nuevaPersona[numeroConductor].licenciaPersona.getTipusLlicencia().equalsIgnoreCase("moto")) {
				...
				throw new tipoLicenciaIncorecta("moto");
			}
			System.out.println("Quieres añadir un conductor nuevo?");
			respuesta = teclat.nextLine().toLowerCase();
		}
	...
	public static void camion(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas, int numeroVehicle,
			int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
		System.out.println("Que matricula tiene? ");
		String matricula = teclat.nextLine();
		System.out.println("Que marca tiene? ");
		...
		while (respuesta.equalsIgnoreCase("si")) {
			...
			if (nuevaPersona[numeroConductor].licenciaPersona.getTipusLlicencia().equalsIgnoreCase("camion")) {
				...
				throw new tipoLicenciaIncorecta("camion");
			}
			System.out.println("Quieres añadir un conductor nuevo?");
			respuesta = teclat.nextLine().toLowerCase();
		}
	...
	public static void eleccion(Vehiculo[] nuevoVehicle, Persona[] nuevaPersona, int numeroPersonas, int numeroVehicle,
			int numeroMaxPersonas, int numeroMaxVehicle) throws tipoLicenciaIncorecta {
		String elec;
